...
export function SetupWizardStepPage({
  ...
  if (step === 'mode') return <Page actions={actions} step={step} subtitle={copy.presentationBody} title={copy.presentationTitle}><ModeOptions copy={copy} selection={selection} update={update} /></Page>
